        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="/pertanyaan/{{$getPertanyaan['id']}}" method="POST">@csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="Konteks" class="col-sm-2 col-form-label">Konteks</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="Konteks" name="Konteks" placeholder="Enter ..." value="{{$getPertanyaan['judul']}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="Tanya" class="col-sm-2 col-form-label">Tanya</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" rows="3" id="Tanya" name="Tanya" placeholder="Enter ...">{{$getPertanyaan['isi']}}</textarea>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-body -->
