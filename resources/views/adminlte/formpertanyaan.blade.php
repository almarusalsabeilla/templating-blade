                    ...
                    <form class="form-horizontal" action="/pertanyaan" method="POST">@csrf
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="Konteks" name="Konteks" placeholder="Enter ...">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="isi" class="col-sm-2 col-form-label">Isi</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" rows="3" id="Tanya" name="Tanya" placeholder="Enter ..."></textarea>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-body -->
